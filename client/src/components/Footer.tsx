...
export function Footer() {
  ...
  const footer = config?.footer ?? FALLBACK;
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-4">
          ...
          >
            ...
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
              className="w-7 h-7 md:w-10 md:h-10 text-white/80 group-hover:text-green-400 transition-colors"
            >
          ...
          <div
            style={{ fontFamily: "var(--font-display)" }}
            className="text-2xl font-bold tracking-wider text-white mb-3"
          >
            {footer.brandText}
          </div>
